...
import { NavigableList, RefHandlers as ListRefHander } from './navigable_list';
...
export const AutoSuggestionInput: FC<Props> = ({
  onChange,
  onSearch,
  value: pills,
  contacts = []
